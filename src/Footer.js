...
function Footer() {
  const [msgMailTitle,setMsgMailTitle] = useState('景賀網站的表單')
        ...
        <div className='md:w-2/3 mx-auto' >
          ...
          <div className='md:w-4/5 md:w-full mx-auto'>
            <form onSubmit={handleSubmit(onSubmit)} className="w-full mx-auto my-5  rel" data-aos="fade-up" data-aos-duration="1500" >
              ...
              <div className='flex w-3/4 mx-auto gap-10 my-3 md:my-12'>
                <button className='border px-2 py-2  font-bold w-full  rounded-full  text-md tracking-wide text-[#fff]' type='submit'>送出</button>
                <button className='bg-[#fff] px-2 py-2  font-bold w-full  rounded-full  text-md tracking-wide text-[#223553]' type='reset'>清除</button>
              </div>
